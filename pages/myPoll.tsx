...
const fetcher = (url: string, userID: string) => axios.get(url, {params: {userID}}).then(res => res.data)
...
const MyPoll: NextPage = () => {
    ...
    const addOptions = () => {
        setOptions((prevState: any) => [...prevState, {
            name: optionName,
            numOfVote: 0
        }])
        setOptionName('')
        ...
        <>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="flex mt-1">
                                            <input value={optionName}
                                                   ...
                                                   placeholder="Options" aria-label="title"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20">
                ...
                {data && data.map((item: any, index: any) => (
                    <PollCard key={index} title={item.title} author={item.author.username} options={item.options}/>
                ))}
            </div>
        </>
    );
